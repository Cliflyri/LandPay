...
<div class="admin-next-card mt-4">
    ...
    <div class="row g-3 mt-1">
        ...
        <div class="col-12"><div class="form-check"><input class="form-check-input" type="checkbox" value="1" name="stage_two_enabled" id="contract_stage_two_enabled" @checked(old('stage_two_enabled',$defaults?->stage_two_enabled ?? true))><label class="form-check-label" for="contract_stage_two_enabled">Enable stage-two late fee</label></div></div>
