...
<div class="col-md-4"><label class="form-label" for="batch-county">County <span class="text-muted">(optional)</span></label><input class="form-control" id="batch-county" name="property_county" list="batch-counties" maxlength="100" value="{{old('property_county',$batch->property_county)}}" placeholder="Choose or type a county"><datalist id="batch-counties">@foreach($counties as $county)<option value="{{$county}}"></option>@endforeach</datalist></div>
