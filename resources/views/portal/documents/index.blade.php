...
<p class="mb-0">Files shared between you and {{ \App\Models\AppSetting::valueFor('company_name', config('app.name', 'LandPay')) }}.</p>

</div><button class="btn btn-sun" type="button" data-bs-toggle="collapse" data-bs-target="#document-upload">Upload document</button></div>
