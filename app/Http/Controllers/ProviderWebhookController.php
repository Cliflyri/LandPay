...
class ProviderWebhookController extends Controller {
 ...
 public function __invoke(Request $request,string $provider): Response {
  ...
  AdminNotice::create(['type'=>'online_payment_received','client_id'=>$intent->client_id,'client_payment_intent_id'=>$intent->id,'title'=>'Online payment received','message'=>$intent->client->first_name.' paid '.\App\Support\Money::format($intent->amount).' by '.ucfirst($provider).'. Payment posted successfully.']);
