...
class PaymentController extends Controller {
 ...
 public function index(Request $request): View { $payments=Payment::query()->whereHas('financialTransaction',fn($q)=>$q->whereIn('payment_plan_id',$request->user('client')->activePlanIds()))->with(['financialTransaction.paymentPlan','financialTransaction.reversedBy'])->latest('received_date')->paginate(20); return view('portal.payments.index',compact('payments')); }
