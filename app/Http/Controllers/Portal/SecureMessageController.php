...
class SecureMessageController extends Controller{
 public function __construct(private readonly SecureMessageFileService $files){}
 ...
 public function store(Request $request):RedirectResponse{
  ...
  return redirect()->route('portal.messages.show',$thread)->with('success','Your secure message was sent.');
 }
