...
class ReportController extends Controller
{
    ...
    private function csvDefinition(string $report, Request $request): array
    {
        return match ($report) {
            ...
            'receivables' => [['Client','Plan','Invoice','Dated','Due','Original','Paid/Credited','Balance','Days overdue','Aging'], fn ($r) => [$this->name($r['client']),$r['plan']->plan_number,$r['model']->invoice_number,$r['issue']->toDateString(),$r['due']->toDateString(),$r['amount']/100,$r['paid']/100,$r['balance']/100,$r['days'],$r['bucket']]],
