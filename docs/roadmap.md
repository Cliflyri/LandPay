...
- DONE Hosted payment checkout through an established processor such as Square or Stripe.
- DONE Signed, idempotent payment-provider webhooks with reconciliation and exception queues.
- DONE A separately authorized client portal for balances, statements, payment history, and overpayment choices.
